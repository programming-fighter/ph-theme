            ...
            <div className="flex gap-2 flex-wrap md:flex-nowrap">
              {headerSetting?.online === "active" && (
                <label
                  ...
                  className={`p-3 rounded space-y-2 w-full transition-colors duration-300 relative flex justify-between border border-gray-300`}
                >
              ...
              {headerSetting?.bkash === "active" && (
                <label
                  ...
                  className={`p-3 rounded space-y-2 w-full transition-colors duration-300 relative flex justify-center border border-gray-300 lg:cursor-pointer`}
                >
              ...
              {advancePay?.status === "1" && (
                <label
                  ...
                  className={`p-3 rounded space-y-2 w-full text-center border border-gray-300`}
                >
                  <div className="lg:cursor-pointer">
                    <h3 className="font-semibold tracking-wider">
                      {"Advance Payment"}
...
export default CheckOutFortyPaymentGateway;
